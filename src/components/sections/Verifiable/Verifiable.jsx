      ...
      <div className={styles.runningLineContainer}>
        <Marquee gradient={false} direction={'right'}>
          <div className={styles.runningLine}>
            <img src="../../../../static/images/running-line-arrow.png" alt="arrow" />
      ...
      <div className={styles.items}>
        <div className={styles.flexgroup}>
          <div className={styles.item}>
            <img src="../../../../static/images/varifiable/picture.png" alt="pic" />
            <h6>{t('verifiable.items.picture')}</h6>
          </div>
          <div className={styles.item}>
            <img src="../../../../static/images/varifiable/audio.png" alt="pic" />
            <h6>{t('verifiable.items.audio')}</h6>
          </div>
          <div className={styles.item}>
            <img src="../../../../static/images/varifiable/video.png" alt="pic" />
            <h6>{t('verifiable.items.video')}</h6>
          </div>
        </div>

        <div className={cn(styles.item, styles.nft)}>
          <img src="../../../../static/images/varifiable/nft.png" alt="pic" />
